...
C5Prediction <- predict(C5_BUILDING, testing)

C5Prediction

postResample(C5Prediction, testing$BUILDINGID)


# Predictions on the Validation set ---------------------------------------

FinalPrediction <- predict(C5_BUILDING, ValData2)
