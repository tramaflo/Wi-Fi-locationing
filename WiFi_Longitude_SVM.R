...
listsub <- createDataPartition(y = TrainData2$LONGITUDE,
                               p = 0.3,
                               list = FALSE)

TrainData30 <- TrainData2[listsub,]
...
FinalPrediction <- predict(SVM_LONGITUDE, ValData2)
...
Specialtable$LONGITUDE <- as.numeric(Specialtable$LONGITUDE)

Specialtable$FinalPrediction <- as.numeric(Specialtable$FinalPrediction)

error <- abs(Specialtable$LONGITUDE - Specialtable$FinalPrediction)

Errorplot <- cbind(Specialtable, error)

plot(Specialtable$FinalPrediction, Specialtable$LONGITUDE)
