...
ValData$TIMESTAMP <- anytime(ValData$TIMESTAMP)
...
KNNPrediction <- predict(KNN_BUILDING, testing)

KNNPrediction

postResample(KNNPrediction, testing$BUILDINGID)


# Predictions on the Validation set ---------------------------------------

FinalPrediction <- predict(KNN_BUILDING, ValData2)
